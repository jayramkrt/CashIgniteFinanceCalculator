...
const SEO = (
  <SeoHead
    title="Loan Statistics & Amortization Schedule — CashIgnite"
    description="View your loan amortization schedule, yearly breakdown and interactive charts. Understand exactly how your EMI is split between principal and interest."
    canonical="https://cashignite.in/statistics"
  />
)
